...
@Service
public class ParserEventUmmawaCom implements Parser {
	private static final Logger logger = LoggerFactory.getLogger(ParserEventUmmawaCom.class);
	
	@Autowired
	private ContentDao			contentDao;
	
	@Bean
	public ParserEventUmmawaCom getParser() {
		return new ParserEventUmmawaCom();
	}
