...
@Service
public class ParserSamsungsalesCoKr implements Parser {
	private static final Logger logger = LoggerFactory.getLogger(ParserSamsungsalesCoKr.class);
	
	@Autowired
	private ContentDao			contentDao;
	
	@Bean
	public ParserSamsungsalesCoKr getParser() {
		return new ParserSamsungsalesCoKr();
	}
