...
@Service
public class ParserMallHyundailivartCoKr implements Parser {
	private static final Logger logger = LoggerFactory.getLogger(ParserMallHyundailivartCoKr.class);
	
	@Autowired
	private ContentDao			contentDao;
	
	@Bean
	public ParserMallHyundailivartCoKr getParser() {
		return new ParserMallHyundailivartCoKr();
	}
