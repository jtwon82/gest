				...
				<div class="content">
					...
					<div class="tableStyle2">
						<table>
							...
							<?
								$images= db_select_list("select * from tbl_board_file where b_idx=".$_GET['idx']);
								foreach($images as $val){
							?>
							<tr>
								<th>etc1</th>
								<td><img src="http://weespk.iptime.org:8020/<?=$_GET['idx']?>-<?=$val[idx]?>.png" width='200'><a href='javascript:;' target="pop" onclick="window.open('<?=$val[filename]?>','pop','width=500,height=500')"><?=$val[filename]?></a></td>
							</tr>
							<?
								}
							?>
