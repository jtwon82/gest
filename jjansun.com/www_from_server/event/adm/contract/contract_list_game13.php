...
<?
							...
							$where = "where userid in(
									select DISTINCT b.userid from tbl_chance a join tbl_member b on a.ssn=b.ssn where chance_type ='add' and chance_type2 like 'game13%' and `current` =100
								) ";
...
?>
					<!-- Button -->
					<div id="btn_top">
						<span class="button blue"><a href="contract_excel_game13.php?search=<?=urlencode($where)?>">엑셀다운</a></span>
