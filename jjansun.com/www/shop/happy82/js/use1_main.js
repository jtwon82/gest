	...
	function scratchStart(){
		$.ajax({
			...
			success: function(req) {
				...
				if(result == 1)resultBg = "images/use1/scratch_pad_1.png";
				if(result == 2)resultBg = "images/use1/scratch_pad_2.png";
				if(result == 3)resultBg = "images/use1/scratch_pad_3.png";
				if(result == 4)resultBg = "images/use1/scratch_pad_4.png";
				if(result == 5)resultBg = "images/use1/scratch_pad_5.png";
				if(result == 6)resultBg = "images/use1/scratch_pad_6.png";
